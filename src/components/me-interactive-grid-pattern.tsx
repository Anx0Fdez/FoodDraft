...
export function InteractiveGridPatternDemo() {
  return (
    ...
    <div className="relative flex h-screen w-full flex-col items-center justify-center overflow-hidden rounded-lg border bg-background md:shadow-xl">
      ...
      <p className="z-10 whitespace-pre-wrap text-center text-5xl font-medium tracking-tighter text-yellow-500 dark:text-yellow-300">
        Interactive Grid Pattern
      </p>
      {/* Componente de patrón de cuadrícula interactivo */}
      <InteractiveGridPattern
        className={cn(
          "[mask-image:radial-gradient(750px_circle_at_center,white,transparent)]", // Gradiente radial para el difuminado
