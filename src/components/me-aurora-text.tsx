...
export function AuroraTextDemo() {
  return (
    ...
    text-3xl // Aplica un tamaño de fuente grande (aproximadamente 2.25rem)
    md:text-4xl // Aplica un tamaño de fuente grande (aproximadamente 3rem) en pantallas medianas 
    lg:text-6xl // Aplica un tamaño de fuente grande (aproximadamente 5rem) en pantallas grandes
